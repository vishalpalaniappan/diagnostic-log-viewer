...
* This demo was generated by injecting logs into the [Library Manager][library-manager] sample program in the [ADLI][adli-url] tool.
* The sample program contains a Semantic Design Graph (SDG) which is included in the header of the trace file generated by the execution.

...
A demo of the viewer is available here (coming soon!).
* The demo CDL file was generated by injecting diagnostic logs into the [compress.py program][yscope-previews] from the yscope-previews repo.

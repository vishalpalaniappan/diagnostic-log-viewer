...
* This trace viewer uses the SDG to create a SEG through the execution with instrumented abstractions and allows the user to navigate the trace using this graph.
